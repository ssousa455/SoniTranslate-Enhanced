...
LANGUAGES = {
    ...
    "Polish (pl)": "pl",
    "Portuguese (pt)": "pt",
    "Portuguese - Brazilian (pt-BR)": "pt-BR",  # Added Brazilian Portuguese
    "Russian (ru)": "ru",
    "Spanish (es)": "es",
    "Turkish (tr)": "tr",
    "Ukrainian (uk)": "uk",
...
EXTRA_ALIGN = {
    ...
    "pt-BR": "jonatasgrosman/wav2vec2-large-xlsr-53-portuguese-brazilian",  # Added Brazilian Portuguese
}
